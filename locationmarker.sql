...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2020 at 05:17 AM
...
(1, 'JSR', 3, 'DSFEDFS5467', 'SDFSDF435968', 'FGH876897856', '', '', '', '', '', '', '', '', ''),
(2, 'KYJ', 2, 'ASDGF87978', 'FDGDFG1234', '', '', '', '', '', '', '', '', '', ''),
(3, 'LRT', 1, 'ASDH98890089', '', '', '', '', '', '', '', '', '', '', ''),
(4, 'UYT', 5, 'LSDFHHIH234', 'LSDFHHIH234', 'LSDFHHIH234', 'LSDFHHIH234', 'LSDFHHIH234', '', '', '', '', '', '', ''),
(5, 'TPR', 2, 'KJHH234KIDSG', 'LSDFHHIH234', '', '', '', '', '', '', '', '', '', '');
...
(4, 'PJR', 'GTR', 'APX', 5000, 5000, 'HNSJSDFJK235', 'JKLSDFHJKL34'),
(6, 'RESTABES', 'GTR', 'APX', 5000, 5000, 'HNSJSDFJK235', 'JKLSDFHJKL22');
...
(2, 'Jember', '-8.2652689', '113.5133798', 3),
(3, 'Jombang', '-7.5611163', '112.1191473', 2),
(4, 'Bojonegoro', '-7.1560458', '111.8785384', 1),
(5, 'Banyuwangi', '-8.2168821', '114.3486412', 2),
(6, 'Malang', '-7.9785589', '112.5967636', 3),
(7, 'Situbondo', '-7.7982314', '113.8798188', 3);
...
(1, 'SST', 110, 'TRUNGKING DIGITAL', 5, 'HGJHJK8685567', 'FGJKFD8778567', 'DFGFDGJHJG6775', 'FDGDFGSDF56456', 'FDGDFGJGFFGH457', '', '', '', '', '', '', '');
...
(14, 'Maulien Selebritish', 'michelmichel12@gmail.com', 'seadanya', '08978667858'),
(15, 'Nada Tiara', 'asdasd@adsasd', 'Patrang', '08978667858'),
(16, 'tutik', 'michel', 'Patrang', '08978667858');
...
--
ALTER TABLE `combiner`
  MODIFY `id_combiner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `convensional`
--
ALTER TABLE `convensional`
  MODIFY `id_convensional` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `login`
  MODIFY `id_login` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `tower`
  MODIFY `id_tower` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `tower`
  ...
  ADD CONSTRAINT `tower_ibfk_4` FOREIGN KEY (`id_convensional`) REFERENCES `convensional` (`id_convensional`);
COMMIT;
