    ...
    <?php $no =1;
        ...
        <tr><td><?php echo $no++;?></td>
            ...
            <?php
                 ...
                 echo '<a href="'.base_url('Data_admin/edit/'.$baris->id_convensional).'" class="btn btn-success btn-icon-split"><i class="fas fa-edit" style="padding: 5px;"></i></a>';
                 echo "  ";
                echo '<a href="'.base_url('Data_admin/hapus/'.$baris->id_convensional).'" class="btn btn-danger btn-icon-split"><i class="fas fa-trash" style="padding: 5px;"></i></a>';
