...
class InfoLokasi extends CI_Controller{
    ...
    public function tambah(){
        ...
        $data['user'] = $this->db->get('user')->row_array();
        ///////////////////////////////////////////////////////
        $this->template->views('crud/tower/tambah_combiner',$data);
    }
    public function tambah1(){
        ...
        $data['user'] = $this->db->get('user')->row_array();
        ///////////////////////////////////////////////////////
        $this->template->views('crud/tower/tambah_conven',$data);
    }
    public function tambah2(){
        ...
        $data['user'] = $this->db->get('user')->row_array();
        ///////////////////////////////////////////////////////
        $this->template->views('crud/tower/tambah_tipe_tower',$data);
    }
