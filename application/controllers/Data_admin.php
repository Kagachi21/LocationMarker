...
class Data_admin extends CI_Controller{
    ...
    public function index(){
        ...
        //////////////////////////////////////////////////////////////
        $data['userku'] = $this->Admin_model->tampil()->result();
    ...
    public function edit($id){
        ...
        $data['userku'] = $this->Admin_model->edit_data($where, 'login JOIN level USING(id_level) JOIN user USING(id_user)')->result();
    ...
    public function tambah(){
        ...
        $data['user'] = $this->db->get('user')->row_array();
        //////////////////////////////////////
        $this->template->views('crud/tambah_admin', $data);
    }
    public function tambah1(){
        ...
        $data['user'] = $this->db->get('user')->row_array();
        /////////////////////////////////////////////////
        $data['akses']=$this->Admin_model->lev()->result_array();
